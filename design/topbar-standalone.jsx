...
const FLAGS = {
  vi: window.__resources && window.__resources.flagVn || 'assets/flags/vn.svg',
  en: window.__resources && window.__resources.flagUs || 'assets/flags/us.svg',
  ja: window.__resources && window.__resources.flagJp || 'assets/flags/jp.svg',
};
