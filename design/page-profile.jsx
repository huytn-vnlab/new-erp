...
const PageProfile = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Hero ── */}
      <div className="card-surface overflow-hidden rise relative" style={{ animationDelay: '0ms' }}>
        {/* Unified accent wash — single soft corner glow, no horizontal banding */}
        <div className="absolute inset-0 pointer-events-none"
        style={{ backgroundImage: `radial-gradient(115% 130% at 100% 0%, hsl(${avatarHue} 58% 56% / 0.12), transparent 55%)` }} />
        {/* Accent rail — the focal điểm nhấn */}
        ...
        <div className="px-7 py-6 relative z-10">
          <div className="flex items-center justify-between gap-4 mb-4">
            <div className="flex items-center gap-5">
              <div className="h-20 w-20 rounded-2xl shadow-lg ring-4 ring-card flex items-center justify-center text-[26px] font-bold text-white font-heading shrink-0"
